...
[Outputs]
  ...
  file_base = './out/pr_wu_plane_stress_p${p0}_t${T0}_l${l}_h4_rf${refine}/pr_wu'
  # file_base = './out/pr_wu_plane_stress_p${p0}_t${T0}_l${l}_h0.25/pr_wu'
  checkpoint = true
  [csv]
    file_base = './gold/pr_wu_plane_stress_p${p0}_t${T0}_l${l}_h4_rf${refine}'
    # file_base = './gold/pr_wu_plane_stress_p${p0}_t${T0}_l${l}_h0.25'
    type = CSV
  []
[]