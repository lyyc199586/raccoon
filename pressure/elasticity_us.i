...
[Outputs]
  ...
  file_base = './out/pr_us_wh_accept_seed${seed}_patch4_p${p0}_t${T0}_ts${sigma_ts}_cs${sigma_cs}_gc${Gc}_l${l}_h1_rf${refine}/pr'
  # file_base = './out/pr_nuc24_seed${seed}_patch10_p${p0}_t${T0}_ts${sigma_ts}_cs${sigma_cs}_gc${Gc}_l${l}_h0.5/pr_nuc24'
  checkpoint = true
  [csv]
    file_base = './gold/pr_us_wh_accept_seed${seed}_patch4_p${p0}_t${T0}_ts${sigma_ts}_cs${sigma_cs}_gc${Gc}_l${l}_h1_rf${refine}'
