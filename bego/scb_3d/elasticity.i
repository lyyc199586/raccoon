...
[Mesh]
  [fmg]
    ...
    file = '../mesh/scb_3d_cw1_half.msh'
  []
  [bot_right]
    type = BoundingBoxNodeSetGenerator
    new_boundary = bot_right
    bottom_left = '16 -0.1 -0.1'
    top_right = '17 0.1 0.1'
    input = fmg
  []
  [top]
    type = BoundingBoxNodeSetGenerator
    new_boundary = top
    bottom_left = '-0.001 24.994 -0.01'
    top_right = '0.5001 25 0.06'
    input = bot_right
  []
  [center]
    type = BoundingBoxNodeSetGenerator
    new_boundary = center
    bottom_left = '-0.001 12.499 -0.01'
    top_right = '0.001 25.001 0.06'
    input = top
  []
[]
