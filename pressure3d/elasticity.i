...
[Outputs]
  ...
  file_base = './out/pr3d_seed${seed}_patch4_p${p0}_t${T0}_ts${sigma_ts}_cs${sigma_cs}_gc${Gc}_l${l}_h4_rf${refine}/pr3d'
  checkpoint = true
  [csv]
    file_base = './gold/pr3d_seed${seed}_patch4_p${p0}_t${T0}_ts${sigma_ts}_cs${sigma_cs}_gc${Gc}_l${l}_h4_rf${refine}'
    type = CSV
  []
[]
