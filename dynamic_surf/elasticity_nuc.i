...
[MultiApps]
  [fracture]
    ...
    input_files = fracture_nuc.i
    # cli_args = 'E=${E};K=${K};G=${G};Lambda=${Lambda};Gc=${Gc};l=${l};psic=${psic};nx=${nx};ny=${ny};refine=${refine};length=${length};a=${a}'
    cli_args = 'E=${E};K=${K};G=${G};Lambda=${Lambda};Gc=${Gc};l=${l};;sigma_ts=${sigma_ts};sigma_hs=${sigma_hs};a=${a}'
...
[Materials]
  [bulk]
    ...
    prop_names = 'E K G lambda Gc l density'
    prop_values = '${E} ${K} ${G} ${Lambda} ${Gc} ${l} ${rho}'
  []
  [crack_geometric]
