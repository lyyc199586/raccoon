...
[Outputs]
  ...
  []
  file_base = './out/${material}_sharp_rho${rho}_tlag${t_lag}_tc${tc}_tf${tf}_v${V}_h${h}_ref${refine}/${material}_sharp'
  print_linear_residuals = false
  [csv]
    type = CSV
    file_base = './gold/${material}_sharp_rho${rho}_tlag${t_lag}_tc${tc}_tf${tf}_v${V}_h${h}_ref${refine}'
  []
[]