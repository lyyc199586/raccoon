...
filebase = nuc20_p${p}_l${l}_h${h}_rf${refine}_tb${Tb}_tf${Tf}
...
[MultiApps]
  [fracture]
    ...
    input_files = fracture_nuc20.i
    cli_args = 'E=${E};K=${K};G=${G};Lambda=${Lambda};Gc=${Gc};l=${l};h=${h};sigma_cs=${sigma_cs};sigma_ts=${sigma_ts};refine=${refine};delta=${delta}'
