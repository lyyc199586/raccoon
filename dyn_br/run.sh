...
# nohup mpirun -n 14 ~/projects/raccoon/raccoon-opt -i elasticity_coh_cf.i > log.txt 2>&1 &
# nohup mpirun -n 14 ~/projects/raccoon/raccoon-opt -i elasticity_cf.i > log.txt 2>&1 &
