...
//   ADReal sigma_hs = 2 / 3 * _sigma_ts[_qp] * _sigma_cs[_qp] / (_sigma_cs[_qp] - _sigma_ts[_qp]);
//   ADReal sigma_ts = _sigma_ts[_qp];
  ...
  _ex_driving[_qp] = _mu[_qp] * alpha_2 * std::sqrt(J2) + alpha_1 * I1;
