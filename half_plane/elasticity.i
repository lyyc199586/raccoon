...
[Outputs]
  ...
  file_base = './out/nuc24_sts${sigma_ts}_scs${sigma_cs}_rho${rho}_u${u0}_l${l}_tp${Tp}_tf${Tf}/nuc24'
  time_step_interval = 1
  [csv]
    file_base = './gold/nuc24_sts${sigma_ts}_scs${sigma_cs}_rho${rho}_u${u0}_l${l}_tp${Tp}_tf${Tf}'
    type = CSV
  []
[]
