...
df1 = pd.read_csv("../gold/tip_half_tan_p20_gc9e-3_ts30_cs330_l0.25_delta-0.625.csv")
...
ax.plot(x.iloc[:, 0]+35, x.iloc[:, 1]-26.08, 'x', label='Experiment', color='grey')
ax.plot(df1["tip_x"], df1["tip_y"], label='$\mathcal{G}_c=9$ N/m, $p=20$ MPa', color=colors[0])
