...
[Outputs]
  ...
  file_base = '../out/half_tan_p${p}_gc${Gc}_ts${sigma_ts}_cs${sigma_cs}_l${l}_d${delta}_h${refine}/half_p${p}_gc${Gc}_ts${sigma_ts}_cs${sigma_cs}_l${l}_d${delta}_h${refine}'
  # file_base = '../out/hht_half_test'
  interval = 1
  [pp]
    type = CSV
    file_base = '../gold/pp_half_tan_p${p}_gc${Gc}_ts${sigma_ts}_cs${sigma_cs}_l${l}_d${delta}_h${refine}'
  []
  [tip]
    type = CSV
