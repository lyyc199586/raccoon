...
[Functions]
  [p_func] # trapezoidal loading pulse
    ...
    # x = '0 17.5e-6 57.5e-6 75e-6 80e-6'
    y = '0 ${p} ${p} 0 0'
  []
  [t_factor_x]
...
[Outputs]
  ...
  file_base = '../out/soda_tan_nuc24_p${p}_gc${Gc}_ts${sigma_ts}_cs${sigma_cs}_l${l}_h${h}_rf${refine}/soda_tan'
  # file_base = '../out/hht_half_test'
  interval = 1
  checkpoint = true
  [pp]
    type = CSV
    file_base = '../gold/soda_tan_nuc24_p${p}_gc${Gc}_ts${sigma_ts}_cs${sigma_cs}_l${l}_h${h}_rf${refine}'
  []
  # [tip]
  #   type = CSV
